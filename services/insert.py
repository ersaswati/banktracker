...
class InsertModule:
    ...
    @staticmethod
    def create_account_gui(data_file_path):
        name = input("Enter your full name: ")
        account_number = str(random.randint(1000000000, 9999999999))
        print("Your Account Number:", account_number)
        while True:
    ...
    @staticmethod
    def create_account_questionary(data_file_path):
        name = input("Enter your full name: ")
        account_number = str(random.randint(1000000000, 9999999999))
        print("Your Account Number:", account_number)
        while True:
        ...
        interaction_log = {
            ...
            "Enter your bank_name:": bank_name,
            "Enter your IFSC code:": ifsc,
            "Enter your account_type:": account_type
        }

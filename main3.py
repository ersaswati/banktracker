...
import json
import easygui
from services.insert2 import InsertModule
from services.get2 import GetModule
from services.update2 import UpdateModule
from services.delete2 import DeleteModule


class MainBankSystem:
    def __init__(self, data_file_path, log_file_path):
